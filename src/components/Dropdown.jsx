...
export default function Dropdown({
    ...
    return (
        <div className="flex items-center gap-2 justify-end pr-12 flex-1 font-primary">
            ...
            <select
                className="px-3 py-2 text-base border rounded-md transition border-primary focus:ring
                focus:ring-dark focus:outline-none text-gray-900 dark:text-cyan-100"
                value={selectedValue}
                onChange={(event) => handleSort(event, event.target.value)}
            >
