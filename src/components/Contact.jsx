    ...
    return (
        <div className="max-w-[1152px] min-h-[852px] mx-auto px-6 py-8 font-primary bg-normalbg dark:bg-darkbg">
            ...
            <Form method="POST" className="space-y-6 max-w-[768px] mx-auto">
                ...
                {/* Submit Button */}
                <div className="text-center" onSubmit={submitForm}>
                    <button type="submit" className="px-6 py-2 text-blue-900
                    dark:text-black text-xl rounded-md transition duration-200
...
// action function for form
// eslint-disable-next-line react-refresh/only-export-components
export async function submitForm({request}) {
    ...
    try {
        const response = await apiClient.post("/contacts", body)// Axios POST Request
